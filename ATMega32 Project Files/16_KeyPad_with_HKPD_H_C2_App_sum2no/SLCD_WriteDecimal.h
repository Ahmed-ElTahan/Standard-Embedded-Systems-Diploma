...
#define digits	3 // maximum number of digits used to be written on the LCD screen

// function prototype
LCD_vidWriteDecimal(u32 x); // function used to write the decimal value on the LCD screen
