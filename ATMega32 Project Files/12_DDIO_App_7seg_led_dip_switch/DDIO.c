...
/*
	  This code contains three functions:
 	  1- Function to set the pin number (0 to 31) direction as Input/Output.
  	  Inputs (PinNumber, PinDirection) PinNumber: 0-31, PinDirection:0 for Input (use clear bit), 1 for Output (use set bit) -- no outputs
	  note: first if is to know the port, nested if to set the pin as input/output.
...
// Function (3): to get the value of the input pin
