...
/*
	...
	the fast PWM mode of wave generation method. The servo position is changed using the value of OCR0 register
...
void main(void)
{
	...
	// Module Initialization
		// Timers Initialization (Fast PWM, 1024 prescaler, OC0 pin high till output compare match, low till overflow)
			...
			OCR0 = 11; // value between (7.8125 and 15.625) (-90 and 90 degree)
